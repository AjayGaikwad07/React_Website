  ...
  return (
    ...
    >
      <StackColumn>
        ...
        />
        <FooterLink 
        text={'info@software.com'} 
        />
      </StackColumn>
      
      <StackColumn>
        <FooterTitle text={'our services'} />
        <FooterLink text={'Software Services'} />
        <FooterLink text={'Web services'} />
        <FooterLink text={'Application Services'} />
        <FooterLink text={'ERP Services'} />
      </StackColumn>
      <StackColumn>
